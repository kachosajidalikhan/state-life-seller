        ...
        <>
            ...
            <div className="w-full max-w-3xl mx-auto rounded-lg">
                <div className="px-6 py-4">
                    <h2 className="text-2xl font-bold text-slate-700">Seller Post Ad</h2>
                </div>
                ...
                <div className="flex justify-end px-6 pb-6">
                    ...
                    <button
                    onClick={()=>{ nav("/my-properties")}}
                        className="flex items-center justify-center py-2 px-4 text-white font-semibold rounded-lg bg-[#1252AE] hover:bg-blue-700"
                    >
