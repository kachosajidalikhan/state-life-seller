...
// Header Component
export function SellerHeader({ toggleSidebar }) {
    ...
    return (<>
        <header className="bg-white w-full flex h-[120px] items-center justify-end px-4 lg:px-6">
            <div className="hidden md:flex w-40 h-20 mb-6 items-center justify-start">
                <a href="/" className="font-bold text-3xl text-blue-600">
                    Logo
                </a>
            </div>
            <div className="bg-white md:w-[78.2vw] h-[120px] flex  items-center md:justify-between px-4 lg:px-6">
                <div className="flex items-center justify-between w-full md:w-auto">
                    ...
                    <div className="md:hidden flex w-40 h-20 mb-6 items-center justify-center">
                        <a href="/" className="font-bold text-3xl text-blue-600">
                            Logo
                        </a>
                    </div>
